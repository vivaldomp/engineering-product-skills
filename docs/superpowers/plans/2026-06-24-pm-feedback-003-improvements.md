...
- `skills/{pm-adr-builder,pm-doc-sync,pm-sad-builder,pm-sdd-builder,pm-import,pm-product-workflow}/SKILL.md` (Tasks 4, 8, 9, 11, 12, 13, 14, 15, 16)
...
**Files:**
- Modify: `shared/templates/adr-template.md` (front-matter), `skills/pm-adr-builder/SKILL.md`, `skills/pm-doc-sync/SKILL.md`
...
In `skills/pm-adr-builder/SKILL.md`, in the front-matter guidance, add a bullet:

```markdown
- When FR/NFR live in an SRS, link them via `related-srs` (e.g. `["§3 FR-012"]`).
```

In `skills/pm-doc-sync/SKILL.md`, where related-* links are parsed/checked, add `related-srs` to the list of ADR relationship fields it reads and reciprocity-checks.
...
```bash
git add plugins/product-design-suite/shared/templates/adr-template.md plugins/product-design-suite/skills/pm-adr-builder/SKILL.md plugins/product-design-suite/skills/pm-doc-sync/SKILL.md tests/metadata-conventions.test.js
...
**Files:**
- Modify: `shared/templates/srs-template.md`, `shared/templates/sad-template.md`, `skills/pm-srs-builder/SKILL.md`, `skills/pm-sad-builder/SKILL.md`
- Test: `tests/metadata-conventions.test.js`
...
In `skills/pm-srs-builder/SKILL.md` and `skills/pm-sad-builder/SKILL.md`, add a line directing the builder to fill the `MODE-BANNER` slot with the mode orientation note instead of inventing an ad-hoc banner.
...
```bash
git add plugins/product-design-suite/shared/templates/srs-template.md plugins/product-design-suite/shared/templates/sad-template.md plugins/product-design-suite/skills/pm-srs-builder/SKILL.md plugins/product-design-suite/skills/pm-sad-builder/SKILL.md tests/metadata-conventions.test.js
...
**Files:**
- Modify: `plugins/product-design-suite/scripts/mermaid-preview.js` (clearer CLI path output), `skills/pm-sdd-builder/SKILL.md`, `skills/pm-sad-builder/SKILL.md`, `skills/pm-product-workflow/SKILL.md`
...
In `pm-sdd-builder`, `pm-sad-builder`, and `pm-product-workflow` SKILL.md, add a sentence offering the lighter path: *"For a quick look without the preview server, run `node scripts/mermaid-preview.js <draft.md> <out.html>` and open the returned file directly."*
...
```bash
git add plugins/product-design-suite/scripts/mermaid-preview.js plugins/product-design-suite/skills/pm-sdd-builder/SKILL.md plugins/product-design-suite/skills/pm-sad-builder/SKILL.md plugins/product-design-suite/skills/pm-product-workflow/SKILL.md tests/mermaid-preview.test.js
...
**Files:**
- Modify: `skills/pm-sad-builder/SKILL.md`, `skills/pm-sdd-builder/SKILL.md`
...
In the diagram section of both `pm-sad-builder` and `pm-sdd-builder` SKILL.md, add:
...
```bash
git add plugins/product-design-suite/skills/pm-sad-builder/SKILL.md plugins/product-design-suite/skills/pm-sdd-builder/SKILL.md tests/diagram-conventions.test.js
...
**Files:**
- Modify: `skills/pm-import/SKILL.md`
...
```js
test('pm-import documents a machine-readable import-map.json (C1)', () => {
...
In `skills/pm-import/SKILL.md`, in the output section (alongside the prose gap report), add:
...
```bash
git add plugins/product-design-suite/skills/pm-import/SKILL.md tests/import-conventions.test.js
git commit -m "feat: pm-import emits machine-readable import-map.json (C1)"
```
...
In `skills/pm-import/SKILL.md` add:
...
**Files:**
- Modify: `shared/references/questioning-protocol.md`, `skills/pm-product-workflow/SKILL.md`, and the builder skills (`pm-prd-builder`, `pm-srs-builder`, `pm-sad-builder`, `pm-sdd-builder`, `pm-adr-builder`) to reference it
...
- Modify: `skills/pm-product-workflow/SKILL.md`, `skills/pm-doc-sync/SKILL.md`
...
In `pm-product-workflow` SKILL.md final step and `pm-doc-sync` SKILL.md, document running `node scripts/consistency-gate.js .product` as the final consistency check that reports one pass/fail summary.
...
```bash
git add plugins/product-design-suite/scripts/consistency-gate.js plugins/product-design-suite/skills/pm-product-workflow/SKILL.md plugins/product-design-suite/skills/pm-doc-sync/SKILL.md tests/consistency-gate.test.js
