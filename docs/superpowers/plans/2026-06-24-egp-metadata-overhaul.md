...
**Goal:** Give the PRD/SDD/ADR templates a first-class YAML front-matter metadata block, add structured `supersedes`/`superseded-by`/`amends`/`amended-by` fields to the ADR (restoring `Status` to a clean enum), and wire the builder skills and `egp-doc-sync` to populate and maintain it.
...
**Files:**
- Modify: `plugins/product-design-suite/skills/egp-adr-builder/SKILL.md:25-28` (steps 4–5)
- Modify: `plugins/product-design-suite/skills/egp-prd-builder/SKILL.md:27-28` (step 6)
- Modify: `plugins/product-design-suite/skills/egp-sdd-builder/SKILL.md:51` (step 7)
- Modify: `plugins/product-design-suite/skills/egp-doc-sync/SKILL.md:22-26` (step 3)
...
- [x] **Step 3: Update egp-adr-builder**

In `plugins/product-design-suite/skills/egp-adr-builder/SKILL.md`, replace step 4:
...
- [x] **Step 4: Update egp-prd-builder**

In `plugins/product-design-suite/skills/egp-prd-builder/SKILL.md`, replace step 6:
...
- [x] **Step 5: Update egp-sdd-builder**

In `plugins/product-design-suite/skills/egp-sdd-builder/SKILL.md`, replace step 7:
...
- [x] **Step 6: Update egp-doc-sync**

In `plugins/product-design-suite/skills/egp-doc-sync/SKILL.md`, within step 3, after the existing bullet:
...
```bash
git add plugins/product-design-suite/skills/egp-adr-builder/SKILL.md \
        plugins/product-design-suite/skills/egp-prd-builder/SKILL.md \
        plugins/product-design-suite/skills/egp-sdd-builder/SKILL.md \
        plugins/product-design-suite/skills/egp-doc-sync/SKILL.md \
