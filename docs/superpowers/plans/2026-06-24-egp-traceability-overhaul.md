...
### Task 3: Wire the workflow docs (egp-doc-sync, structures.md, egp-sdd-builder)

**Files:**
- Modify: `plugins/product-design-suite/skills/egp-doc-sync/SKILL.md:15-17,28`
- Modify: `plugins/product-design-suite/shared/references/structures.md:445`
- Modify: `plugins/product-design-suite/skills/egp-sdd-builder/SKILL.md:52`
...
- [x] **Step 3: Update `egp-doc-sync` step 1 and step 6**

In `plugins/product-design-suite/skills/egp-doc-sync/SKILL.md`, replace step 1 (lines 15-17):
...
- [x] **Step 5: Update `egp-sdd-builder` step 8**

In `plugins/product-design-suite/skills/egp-sdd-builder/SKILL.md`, replace step 8 (line 52):
...
```bash
git add plugins/product-design-suite/skills/egp-doc-sync/SKILL.md plugins/product-design-suite/shared/references/structures.md plugins/product-design-suite/skills/egp-sdd-builder/SKILL.md tests/traceability-conventions.test.js
