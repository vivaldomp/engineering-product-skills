...
- `skills/egp-*-builder/SKILL.md`, `skills/egp-doc-sync/SKILL.md`, `shared/references/questioning-protocol.md` — `docs/` guard, decision ledger, version-bump heuristic, ADR-index wiring (IMP-4, IMP-9, IMP-10, IMP-11).
...
### Task 10: SDD §15 status sync + egp-doc-sync wiring (IMP-4, part 2)

**Files:**
- Modify: `plugins/product-design-suite/scripts/adr-index.js`, `shared/templates/sdd-template.md` (§15), `skills/egp-doc-sync/SKILL.md`
- Test: `tests/adr-index.test.js`
...
- [x] **Step 5: Wire into egp-doc-sync**

In `skills/egp-doc-sync/SKILL.md`, add a new step after step 1 (renumber following steps):
...
```bash
git add plugins/product-design-suite/scripts/adr-index.js shared/templates/sdd-template.md skills/egp-doc-sync/SKILL.md tests/adr-index.test.js
git commit -m "feat: sync SDD §15 ADR status from front-matter via adr-index + egp-doc-sync (IMP-4)"
```
...
**Files:**
- Modify: `skills/egp-prd-builder/SKILL.md`, `egp-srs-builder/SKILL.md`, `egp-sad-builder/SKILL.md`, `egp-sdd-builder/SKILL.md`, `egp-adr-builder/SKILL.md`, `shared/references/questioning-protocol.md`
- Test: `tests/metadata-conventions.test.js`
...
```bash
git add skills/egp-prd-builder/SKILL.md skills/egp-srs-builder/SKILL.md skills/egp-sad-builder/SKILL.md skills/egp-sdd-builder/SKILL.md skills/egp-adr-builder/SKILL.md shared/references/questioning-protocol.md tests/metadata-conventions.test.js
...
- IMP-4 → Tasks 9–10 (index + §15 status sync + egp-doc-sync). ✓
